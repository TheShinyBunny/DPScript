...
public class Parser {
    ...
    private String parseNBTValue() {
        if (tokens.isNext(TokenType.INT,TokenType.DOUBLE)) {
            ...
            if (tokens.isNext(TokenType.IDENTIFIER)) {
                if (tokens.isNext("d","D","s","S","F","f","B","b")) {
                    ...
                    compilationError(ErrorType.INVALID,"NBT number suffix");
                }
            }
            return v;
            ...
            while (!tokens.isNext("]")) {
                ...
                if (tokens.skip(",")) {
                    ...
                    compilationError(ErrorType.EXPECTED,"] or , after NBT array value");
                }
            }
            tokens.skip();
            arr += "]";
        ...
        compilationError(ErrorType.INVALID,"NBT value");
        return "{}";
    }
    ...
    private String parseState() {
        ...
        while (!tokens.isNext("]")) {
            ...
            if (!tokens.isNext("]",",")) tokens.error(ErrorType.INVALID,"block state, expected ] or ,");
        }
        tokens.skip("]");
        state += "]";
        return state;
